    ...
    for projeto in PROJETOS:
        ...
        while True:
            ...
            params = {
                ...
                "startAt": start_at,
                "maxResults": 100,
                "fields": "summary,created,resolutiondate,status,customfield_13686,customfield_13719"
            }
...
campos_assunto = {
    'TDS': 'customfield_13747',
    'INT': 'customfield_13710',
    'TINE': 'customfield_13749',
    'INTEL': 'customfield_13746'
}
...
df_assunto = df[(df['projeto'] == projeto_selecionado) & df['resolved'].notna()].copy()
df_assunto['mes_resolvido'] = df_assunto['resolved'].dt.to_period("M").dt.to_timestamp()
df_assunto['mes_str'] = df_assunto['mes_resolvido'].dt.strftime("%b/%Y")
